    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-header">
                <h2>Welcome To Islington EXAM</h2>
            </div>
            <div class="card-body">
                <p>In this project, we are going to make an online exam system where an admin/teacher can take exam for the current student who are logged in this system. Here, the admin/teacher will take the exam of objective type questions.</p>
